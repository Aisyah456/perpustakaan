...
<head>
    ...
    <!-- title  -->
    <title>Artikel - Perpustakaan UMHT</title>
        ...
        <section>
            <div class="container">
                <div class="section-heading">
                    <span class="sub-title">Categoty</span>
                    <h2 class="h1 mb-0">Artikel Perpuskataan UMHT</h2>
                </div>
                            ...
                            <div class="card card-style1 p-0 h-100">
                                <div class="card-img rounded-0">
                                    <div class="image-hover">
                                        <img class="card-icon center w-60px"
                                            src="{{ asset('lib/img/artikel/' . $artikel->img) }}" alt="...">
                                    </div>
                                    <a href="courses-list.html" class="course-tag">{{ $artikel->category }}</a>
                                    ...
                                    <div class="card-author d-flex">
                                        <div class="avatar">
                                            <img class="rounded-circle"
                                                src="{{ asset('lib/img/avatar/avatar-01.jpg') }}" alt="...">
                                        </div>
                                        <h4 class="mb-0 h6">{{ $artikel->admin }}</h4>
                                    </div>
                                    <div class="pt-6">
                                        <h3 class="h4 mb-4"><a href="course-details.html">{{ $artikel->judul }}</a>
                                        </h3>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="display-30"><i
                                                    class="ti-agenda me-2"></i>{{ $artikel->tanggal }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
