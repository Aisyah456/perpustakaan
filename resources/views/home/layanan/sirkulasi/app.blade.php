...
@section('title', 'Layanan Sirkulasi & Fasilitas Perpustakaan UMHT')
@section('page', 'Layanan Sirkulasi & Fasilitas Perpustakaan UMHT')
...
@section('content')
  <div class="container py-5">
    ...
    <ul class="list-disc pl-5 text-gray-700 mb-4">
      <li>Mahasiswa aktif dapat meminjam maksimal 2 buku sekaligus</li>
      <li>Masa pinjam selama 2 pekan dan dapat diperpanjang 1 kali jika tidak ada reservasi</li>
    ...
    <table class="table-auto border-collapse border border-gray-300 mb-6 text-gray-700">
      ...
      <tbody>
        <tr>
          ...
          <td class="border border-gray-300 px-4 py-2">08.00 - 17.00 WIB</td>
        </tr>
        <tr>
    ...
    <p class="text-gray-700">
      Untuk informasi lebih lanjut terkait layanan sirkulasi, silakan hubungi petugas perpustakaan melalui email: <a
        href="mailto:perpustakaan@thamrin.ac.id" class="text-blue-600 hover:underline">perpustakaan@thamrin.ac.id</a>
      atau kunjungi langsung ruang sirkulasi di lantai 2 gedung A2.
    </p>
  </div>
@endsection
