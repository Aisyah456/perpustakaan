...
@section('content')
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <a class="navbar-brand" href="{{ route('admin.panduan.index') }}">
        <i class="fas fa-book-open"></i> Admin Panduan Perpustakaan
      </a>
      <div class="navbar-nav ms-auto">
        <a class="nav-link" href="{{ route('panduan.index') }}" target="_blank">
