...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            <div class="mb-6">
                @if ($news->img)
                    <img src="{{ asset('doc/img/news/' . $banner->img) }}" alt="Gambar Sambutan"
            ...
            <div class="mb-6">
                <p class="text-lg font-semibold text-gray-800">{{ $banner->judul }}</p>
            </div>

            <div class="mb-6">
                <p class="text-lg font-semibold text-gray-800">{{ $banner->formatted_date }}</p>
            </div>

            <div>
                <p class="mt-2 text-gray-700">{!! $banner->konten !!}</p>
            </div>
        </div>
    </div>
</div>
