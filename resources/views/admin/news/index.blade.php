              ...
              <tbody>
                @forelse($news as $index => $item)
                  <tr>
                    ...
                    {{-- Gambar --}}
                    <td>
                      <img src="{{ asset('lib/img/news/' . $item->img) }}" alt="Gambar" class="rounded"
                        style="height: 60px; object-fit: cover;">
                    </td>

                    {{-- Judul --}}
                    <td class="text-start"><strong>{{ Str::limit($item->judul, 40) }}</strong></td>

                    {{-- Konten singkat --}}
                    <td class="text-start">{{ Str::limit(strip_tags($item->konten), 50) }}</td>
          ...
          <div class="modal fade" id="createModal" tabindex="-1">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <form id="createForm" method="POST" action="{{ route('admin.berita.store') }}"
                      ...
                      <div class="col-md-4">
                        <div class="mb-3">
                          ...
                          <div class="image-upload-area" id="createImageUpload"
                            ...
                            <input type="file" class="d-none" id="create_img" name="img" accept="image/*"
                              required>
                          </div>
