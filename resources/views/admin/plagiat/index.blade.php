...
@section('content')
  <div class="row">
    <div class="col-12">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand" href="{{ route('admin.banners.index') }}">
            <i class="fas fa-images"></i> Admin Data Plagiat UMHT
          </a>
      ...
      <!-- Form Pencarian -->
      <form action="{{ route('plagiat.index') }}" method="GET" class="mb-3">
      ...
      <div class="table-responsive shadow-sm rounded-4 border">
        <table class="table table-hover align-middle mb-0" id="plagiatsTable">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <form action="{{ route('plagiat.store') }}" method="POST">
            @csrf
