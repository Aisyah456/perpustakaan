    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <header class="flex items-center justify-between p-4 mb-6 bg-white rounded-lg shadow">
                <h1 class="text-2xl font-bold text-gray-700">Tambah Berita</h1>
                ...
                <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" placeholder="Masukkan judul berita"
                            value="{{ old('title') }}" class="w-full p-2 border rounded-lg focus:ring focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="by" id="by" placeholder="Nama admin"
                            value="{{ old('by') }}" class="w-full p-2 border rounded-lg focus:ring focus:ring-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" id="content" rows="6" placeholder="Tulis isi berita"
                            class="w-full p-2 border rounded-lg focus:ring focus:ring-blue-500">{{ old('content') }}</textarea>
                    </div>

                    <button type="submit"
                        class="px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700">Simpan</button>
                </form>
            </div>
        </div>
    </div>
